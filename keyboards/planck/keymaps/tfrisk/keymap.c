...
// UPPERCASE keycodes are handled by process_record_user() in the file 'tfrisk.c' from userspace
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT_planck_grid(
        ____, exlm, at,   hash, dlr,  perc, circ, ampr, astr, lprn, rprn, bspc,
        tild, ctrz, ctrx, ctrc, ctrv, xxxx, xxxx, unds, plus, lcbr, rcbr, acut,
        ____, xxxx, xxxx, xxxx, xxxx, xxxx, xxxx, xxxx, xxxx, lbrc, rbrc, ____,
        ____, fn,   lgui, lalt, ____, ____, ____, ____, bsls, pipe, xxxx, xxxx
    ),

    [_RAISE] = LAYOUT_planck_grid(
        ____, n1,   n2,   n3,   n4,   n5,   n6,   n7,   n8,   n9,   n0,   bspc,
        grv,  n4,   n5,   n6,   xxxx, xxxx, xxxx, mins, eql,  xxxx, xxxx, diae,
        ____, n7,   n8,   n9,   xxxx, xxxx, xxxx, xxxx, ____, ____, volu, ____,
        ____, fn,   n0,   lalt, ____, ____, ____, ____, ____, next, vold, play
    ),

    [_FN] = LAYOUT_planck_grid(
        del,  f1,   f2,   f3,   f4,   xxxx, xxxx, xxxx, ins,  xxxx, prnt, aa,
        tab,  f5,   f6,   f7,   f8,   xxxx, xxxx, xxxx, xxxx, xxxx, ae,   oe,
